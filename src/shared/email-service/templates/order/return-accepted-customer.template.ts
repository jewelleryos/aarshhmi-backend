interface ReturnAcceptedCustomerParams {
  firstName: string
  orderNumber: string
...
export const returnAcceptedCustomerTemplate = (params: ReturnAcceptedCustomerParams): string => {
...
<head>
  ...
  <title>Return Request Accepted</title>
</head>
        ...
        <table role="presentation" style="width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="padding: 40px;">
              <h2 style="margin: 0 0 20px; font-size: 20px; font-weight: 600; color: #1a1a1a;">Return Request Accepted</h2>
              ...
              <p style="margin: 0 0 24px; font-size: 16px; line-height: 1.6; color: #4a4a4a;">
                Your return request has been accepted. We will contact you shortly with the next steps regarding the return pickup and refund process.
              </p>
              ...
              <p style="margin: 0 0 10px; font-size: 14px; line-height: 1.6; color: #6a6a6a;">
                You will receive further updates as the return process progresses.
              </p>
