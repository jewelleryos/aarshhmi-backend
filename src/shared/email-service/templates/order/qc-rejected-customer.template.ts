interface QcRejectedCustomerParams {
  firstName: string
  orderNumber: string
...
export const qcRejectedCustomerTemplate = (params: QcRejectedCustomerParams): string => {
...
<head>
  ...
  <title>Quality Check Failed</title>
</head>
        ...
        <table role="presentation" style="width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="padding: 40px;">
              <h2 style="margin: 0 0 20px; font-size: 20px; font-weight: 600; color: #1a1a1a;">Quality Check Failed</h2>
              ...
              <p style="margin: 0 0 24px; font-size: 16px; line-height: 1.6; color: #4a4a4a;">
                Unfortunately, the returned item did not pass our quality check. Our team will be in touch with you to discuss the next steps.
              </p>
