...
interface CancelRequestCustomerParams {
  firstName: string
  orderNumber: string
...
export const cancelRequestCustomerTemplate = (params: CancelRequestCustomerParams): string => {
  const { firstName, orderNumber, suborderNumber, productName, variantName, paidAmount, reason } = params
        ...
        <table role="presentation" style="width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="padding: 40px;">
              <h2 style="margin: 0 0 20px; font-size: 20px; font-weight: 600; color: #1a1a1a;">Cancellation Request Received</h2>
              ...
              <p style="margin: 0 0 24px; font-size: 16px; line-height: 1.6; color: #4a4a4a;">
                We have received your cancellation request for the following order. Our team will review it and get back to you shortly.
              </p>
              ...
              <p style="margin: 0 0 10px; font-size: 14px; line-height: 1.6; color: #6a6a6a;">
                You will receive another email once your cancellation request has been reviewed and a decision has been made.
              </p>
