interface ReturnInTransitCustomerParams {
  firstName: string
  orderNumber: string
...
export const returnInTransitCustomerTemplate = (params: ReturnInTransitCustomerParams): string => {
        ...
        <table role="presentation" style="width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="padding: 40px;">
              <h2 style="margin: 0 0 20px; font-size: 20px; font-weight: 600; color: #1a1a1a;">Return Picked Up</h2>
              ...
              <p style="margin: 0 0 24px; font-size: 16px; line-height: 1.6; color: #4a4a4a;">
                Your return item has been picked up and is now in transit back to us. We will notify you once we receive it.
              </p>
