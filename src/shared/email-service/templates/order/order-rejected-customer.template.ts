interface OrderRejectedCustomerParams {
  firstName: string
  orderNumber: string
...
export const orderRejectedCustomerTemplate = (params: OrderRejectedCustomerParams): string => {
        ...
        <table role="presentation" style="width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="padding: 40px;">
              <h2 style="margin: 0 0 20px; font-size: 20px; font-weight: 600; color: #ef4444;">Order Cancelled</h2>
              ...
              <p style="margin: 0 0 24px; font-size: 16px; line-height: 1.6; color: #4a4a4a;">
                We regret to inform you that your order has been cancelled. Your refund will be processed and you will receive a separate email once the refund is completed.
              </p>

              <!-- Order Info -->
              <table role="presentation" style="width: 100%; border-collapse: collapse; margin-bottom: 24px;">
                <tr>
                  <td style="padding: 16px 20px; background-color: #fef2f2; border-radius: 6px; border-left: 4px solid #ef4444;">
              ...
              <p style="margin: 0; font-size: 14px; line-height: 1.6; color: #6a6a6a;">
                If you have any questions, please feel free to reach out to us. We apologize for the inconvenience.
              </p>
            </td>
          </tr>
