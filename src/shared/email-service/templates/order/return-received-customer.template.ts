interface ReturnReceivedCustomerParams {
  firstName: string
  orderNumber: string
...
export const returnReceivedCustomerTemplate = (params: ReturnReceivedCustomerParams): string => {
        ...
        <table role="presentation" style="width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="padding: 40px;">
              <h2 style="margin: 0 0 20px; font-size: 20px; font-weight: 600; color: #1a1a1a;">Return Received</h2>
              ...
              <p style="margin: 0 0 24px; font-size: 16px; line-height: 1.6; color: #4a4a4a;">
                We have received your return item. Our team will now inspect the product and process your refund accordingly. You will receive an update once the inspection is complete.
              </p>
