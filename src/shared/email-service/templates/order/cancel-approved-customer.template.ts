...
interface CancelApprovedCustomerParams {
  firstName: string
  orderNumber: string
...
export const cancelApprovedCustomerTemplate = (params: CancelApprovedCustomerParams): string => {
        ...
        <table role="presentation" style="width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="padding: 40px;">
              <h2 style="margin: 0 0 20px; font-size: 20px; font-weight: 600; color: #1a1a1a;">Cancellation Request Approved</h2>
              ...
              <p style="margin: 0 0 24px; font-size: 16px; line-height: 1.6; color: #4a4a4a;">
                Your cancellation request has been approved. We have initiated the refund process for your order. You will receive another email once the refund has been processed.
              </p>
                ...
                <tr>
                  <td style="padding: 12px 16px; background-color: #fafafa; border-radius: 6px;">
                    ...
                    <p style="margin: 6px 0 0; font-size: 14px; color: #6a6a6a;">
                      Refund Amount: ${formatPrice(paidAmount)}
                    </p>
                  </td>
                </tr>
              </table>
              ...
              <p style="margin: 0 0 10px; font-size: 14px; line-height: 1.6; color: #6a6a6a;">
                The refund will be credited to your original payment method within 5-7 business days after processing.
              </p>
