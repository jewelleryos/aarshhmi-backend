...
interface ReturnRequestAdminParams {
  orderNumber: string
...
export const returnRequestAdminTemplate = (params: ReturnRequestAdminParams): string => {
        ...
        <table role="presentation" style="width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="padding: 40px;">
              <h2 style="margin: 0 0 20px; font-size: 20px; font-weight: 600; color: #ea580c;">Return Request Received</h2>

              <p style="margin: 0 0 24px; font-size: 16px; line-height: 1.6; color: #4a4a4a;">
                A customer has submitted a return request for the following order. Please review and take appropriate action.
              </p>
              ...
              <p style="margin: 0; font-size: 14px; line-height: 1.6; color: #6a6a6a;">
                Please log into the admin panel to accept or reject this return request.
              </p>
            </td>
          </tr>
