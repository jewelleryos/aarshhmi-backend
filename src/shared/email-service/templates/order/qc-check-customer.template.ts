interface QcCheckCustomerParams {
  firstName: string
  orderNumber: string
...
export const qcCheckCustomerTemplate = (params: QcCheckCustomerParams): string => {
  const { firstName, orderNumber, suborderNumber, productName, variantName } = params
...
<head>
  ...
  <title>Quality Check In Progress</title>
</head>
        ...
        <table role="presentation" style="width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="padding: 40px;">
              <h2 style="margin: 0 0 20px; font-size: 20px; font-weight: 600; color: #1a1a1a;">Quality Check In Progress</h2>
              ...
              <p style="margin: 0 0 24px; font-size: 16px; line-height: 1.6; color: #4a4a4a;">
                Your returned item is now undergoing a quality check. We will notify you once the inspection is complete and update you on the next steps.
              </p>

              <!-- Order Info -->
              <table role="presentation" style="width: 100%; border-collapse: collapse; margin-bottom: 24px;">
                <tr>
                  <td style="padding: 16px 20px; background-color: #fffbeb; border-radius: 6px; border-left: 4px solid #f59e0b;">
