...
export const createDiamondClarityColorSchema = z.object({
...
export const updateDiamondClarityColorSchema = z.object({
...
export const diamondClarityColorIdSchema = z.object({
