...
export const createGemstonePriceSchema = z
  .object({
    stone_type_id: z.string().min(1, 'Gemstone type is required'),
    stone_shape_id: z.string().min(1, 'Shape is required'),
    stone_quality_id: z.string().min(1, 'Quality is required'),
    stone_color_id: z.string().min(1, 'Color is required'),
    ct_from: caratSchema,
    ct_to: caratSchema,
...
export const updateGemstonePriceSchema = z
  .object({
    stone_type_id: z.string().min(1, 'Gemstone type is required').optional(),
    stone_shape_id: z.string().min(1, 'Shape is required').optional(),
    stone_quality_id: z.string().min(1, 'Quality is required').optional(),
    stone_color_id: z.string().min(1, 'Color is required').optional(),
...
export const gemstonePriceIdSchema = z.object({
  id: z.string().min(1, 'ID is required'),
})

export const gemstonePriceFiltersSchema = z.object({
  stone_type_id: z.string().optional(),
  stone_shape_id: z.string().optional(),
  stone_quality_id: z.string().optional(),
  stone_color_id: z.string().optional(),
})
